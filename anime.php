...
<html manifest="manifest.appcache">
  ...
  <body>
    ...
    <div id="intro" style="clear: both; height: 1600px; padding:0px 100px; padding-top: 30px;" class="zIndex-1"><!-- Pjesa statike -->
    <table class="pokerTable" style="padding-top: 20px;padding-bottom: 20px;">
      <tr>
        <td><div class="allSeries leftRotate20N" id="deathNote">
          ...
          <div class="seriesTitle textFont  ">
            <a href="https://www.youtube.com/watch?v=tJZtOrm-WPk">DEATH NOTE</a>
          </div>
        ...
        <td><div class="allSeries leftRotate20N" id="psychoPass">
          ...
          <div class="seriesTitle textFont  ">
            <a href="https://www.youtube.com/watch?v=YzuJnyebc40">PSYCHO PASS</a>
          </div>
          <div class="category textFont">
            Category: Drame
          </div>
        ...
        <td><div class="allSeries rightRotate20N" id="dragonBall">
          ...
          <div class="seriesTitle textFont  ">
            <a href="https://www.youtube.com/watch?v=hgTH0bZysYw">DRAGON BALL</a>
          </div>
          <div class="category textFont">
            Category: Drame
          </div>
        ...
        <td><div class="allSeries rightRotate20N" id="naruto">
          ...
          <div class="seriesTitle textFont  ">
            <a href="https://www.youtube.com/watch?v=j2hiC9BmJlQ">NARUTO</a>
          </div>
          <div class="category textFont">
            Category: Drame
          </div>
      ...
      <tr>
        <td><div class="allSeries leftRotate20N" id="codeGlass">
          ...
          <div class="seriesTitle textFont  ">
            <a href="https://www.youtube.com/watch?v=O9Rdqm_74C0">CODE GLASS</a>
          </div>
          <div class="category textFont">
            Category: Drame
          </div>
        ...
        <td><div class="allSeries leftRotate20N" id="swordArtOnline">
          ...
          <div class="seriesTitle textFont  ">
            <a href="https://www.youtube.com/watch?v=6ohYYtxfDCg">SWORD ART ONLINE</a>
          </div>
          <div class="category textFont">
            Category: Drame
          </div>
        ...
        <td><div class="allSeries rightRotate20N" id="spaceDandy">
          ...
          <div class="seriesTitle textFont  ">
            <a href="https://www.youtube.com/watch?v=aJoukZmLVPA">SPACE DANDY</a>
          </div>
          <div class="category textFont">
            Category: Drame
          </div>
        ...
        <td><div class="allSeries rightRotate20N" id="onePunchMan">
          ...
          <div class="seriesTitle textFont  ">
            <a href="https://www.youtube.com/watch?v=2JAElThbKrI">ONE-PUNCH MAN</a>
          </div>
          <div class="category textFont">
            Category: Drame
          </div>
      ...
      <tr>
        <td><div class="allSeries leftRotate20N" id="theBeginning">
          ...
          <div class="seriesTitle textFont  ">
            <a href="https://www.youtube.com/watch?v=FMxaCRLuRlQ">THE BEGINNING</a>
          </div>
          <div class="category textFont">
            Category: Drame
          </div>
        ...
        <td><div class="allSeries leftRotate20N" id="gurrenLagann">
          ...
          <div class="seriesTitle textFont  ">
            <a href="https://www.youtube.com/watch?v=oXkkMhCuCMg">GURREN LAGANN</a>
          </div>
          <div class="category textFont">
            Category: Drame
          </div>
        ...
        <td><div class="allSeries rightRotate20N" id="k">
          ...
          <div class="seriesTitle textFont  ">
            <a href="https://www.youtube.com/watch?v=mI57Q5E4zWw">K</a>
          </div>
          <div class="category textFont">
            Category: Drame
          </div>
        ...
        <td><div class="allSeries rightRotate20N" id="dragonBallZ">
          ...
          <div class="seriesTitle textFont  ">
            <a href="https://www.youtube.com/watch?v=FHgm89hKpXU">DRAGON BAL Z</a>
          </div>
          <div class="category textFont">
            Category: Drame
          </div>
